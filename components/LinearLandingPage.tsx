...
const LinearLandingPage: React.FC = () => {
  ...
  // Add useEffect for Calendly script loading
  useEffect(() => {
  ...
  return (
    <div className="bg-zinc-950 text-zinc-200 min-h-screen font-sans antialiased">
      ...
      <header className={`fixed top-0 w-full ${scrolled ? 'bg-zinc-950/80 backdrop-blur-lg' : 'bg-transparent'} transition-all duration-200 z-50`}>
        <div className="max-w-5xl mx-auto flex items-center justify-between p-4 lg:px-0">
          ...
          <div className="flex items-center gap-6">
            ...
            <a href="#calendly" className="text-white bg-zinc-800 hover:bg-zinc-700 px-4 py-2 rounded-full text-sm font-medium transition-colors">
              Get started
            </a>
          </div>
        </div>
        ...
        <div className="max-w-5xl mx-auto px-4 lg:px-0">
          <div className="max-w-3xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a href="#calendly" className="inline-flex items-center justify-center bg-white hover:bg-zinc-200 text-black font-medium rounded-lg px-6 py-3 transition-colors">
                Book a demo
        ...
        <div className="max-w-5xl mx-auto px-4 lg:px-0">
          ...
          <div className="grid grid-cols-1 gap-8">
            <div className="bg-zinc-900/50 p-6 rounded-lg border border-zinc-800 hover:border-zinc-700 transition-colors max-w-xl mx-auto">
              ...
              <a href="#calendly" className="inline-flex items-center justify-center w-full bg-white hover:bg-zinc-200 text-black font-medium rounded-lg px-4 py-2 text-sm transition-colors">
                Get started
              </a>
            </div>
          </div>
        ...
        <div className="max-w-5xl mx-auto px-4 lg:px-0">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="group flex flex-col">
              ...
              <a href="#calendly" className="inline-flex items-center mt-auto text-sm text-blue-500 hover:text-blue-400">
      ...
      {/* Calendly Section */}
      <section id="calendly" className="py-20 border-t border-zinc-900">
        <div className="max-w-5xl mx-auto px-4 lg:px-0">
          ...
          <div className="bg-zinc-900/50 p-6 rounded-lg border border-zinc-800">
            <div 
              ...
              data-url="https://calendly.com/servandotorres" 
